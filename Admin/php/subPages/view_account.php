...
<body>
<div class="container w-100 p-2 h-25 ">
    ...
    <div class="col-6 bg-dark  ">
            ...
            <div class="card bg-dark text-white mb-2">
                ...
                <div class="card-header text-white text-center border border-dark border-2">
                    <h1>My Account</h1>
                </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class=" form-group  d-flex justify-content-lg-center" >
                            ...
                            <button class="btn bg-danger mr-3" type="submit" id="changeUsername">Change</button>
                               <a class="btn bg-primary" type="reset" id="changeUsername" href="../Pages/admin-dashboard.php"> Close</a>
