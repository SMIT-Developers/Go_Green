...
<head>
    ...
    <title>Entertainment Area | Dashboard </title>
    ...
    <div class="col-lg-12">
        ...
        <div class="card my-2 border-success">
            ...
            <div class="card-header bg-success text-white">
                ...
                <div class="col-lg-12">
                    <h4>Entertainment Area
                        <a
                            type="submit"
                            class="btn add-btn mb-2 "
                            href="../subPages/add_new_gallery_EA.php"
                           >
                            Add new Item
                        </a>
                    </h4>
                        ...
                        <form class="form-group">
                            ...
                            <div class="input-group mb-3 rounded ">
                                ...
                                <input type="search" class="form-control rounded" placeholder="Enter Gallery Name Item Name " aria-label="Search"
                                       aria-describedby="search-addon" id="searchEnterArea" name="searchEnterArea"/>
