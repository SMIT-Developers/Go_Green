...
$tableData = viewAllResearchers($conn);
...
<head>
    ...
    <title>Researcher Users | Dashboard </title>
        ...
        <div class="card my-2 border-success">
            ...
            <div class="card-body">
                <div class="search-container">
                    <form action="researcher.php" id="searchResearcher" method="get">
                        <div class="input-group rounded">

                            <input type="search" class="form-control rounded" placeholder="Enter First Name, Last Name, Email or Id" aria-label="Search"
                                   aria-describedby="search-addon" id="searchResearcher" name="searchResearcher"/>
